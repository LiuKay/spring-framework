...
class DefaultListableBeanFactoryTests {
	...
	void unreferencedSingletonWasInstantiated() {
		...
		//PropertiesBeanDefinitionReader 会解析Properties的内容并注册 beanDefinition
		//beanName=x1, beanClass=KnowsIfInstantiated.class
	...
	void factoryBeanDidNotCreatePrototype() {
		...
		// Reset static state
		DummyFactory.reset();
		//x1.singleton => 设置 DummyFactory 的属性字段 singleton=false, (Bean Scope 默认是singleton)
